          ...
          <div className="overflow-x-auto">
            <div className="flex gap-6 min-w-max justify-center pb-4">
              ...
              >
                ...
                <div className="text-2xl font-bold text-gray-800 mb-2">150+</div>
              ...
              >
                ...
                <div className="text-2xl font-bold text-gray-800 mb-2">1,200+</div>
              ...
              >
                ...
                <div className="text-sm text-gray-600 whitespace-nowrap">Countries</div>
              </motion.div>
            </div>
          </div>
        </div>
